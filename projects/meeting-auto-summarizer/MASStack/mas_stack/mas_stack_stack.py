...
class MasStackStack(Stack):
  def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
    ...
    props = {
      ...
      'imageUri': kwargs.get('imageUri', '763104351884.dkr.ecr.us-east-1.amazonaws.com/huggingface-pytorch-inference:1.10.2-transformers4.17.0-gpu-py38-cu113-ubuntu20.04'),
      'modelData': kwargs.get('modelData', 's3://jumpstart-cache-prod-us-east-1/huggingface-infer/prepack/v1.0.3/infer-prepack-huggingface-text2text-flan-t5-xl.tar.gz'),
    ...
    # Resources
    generateMeetingNotesLogGroup = logs.CfnLogGroup(self, 'GenerateMeetingNotesLogGroup',
          log_group_name = f"""/aws/lambda/{self.stack_name}-GenerateMeetingNotes""",
        )

    generateMeetingTranscriptLogGroup = logs.CfnLogGroup(self, 'GenerateMeetingTranscriptLogGroup',
          log_group_name = f"""/aws/lambda/{self.stack_name}-GenerateMeetingTranscript""",
        )

    loggingBucket = s3.CfnBucket(self, 'LoggingBucket',
    ...
    generateMeetingNotesLambdaRole = iam.CfnRole(self, 'GenerateMeetingNotesLambdaRole',
    ...
    generateMeetingTranscriptLambdaRole = iam.CfnRole(self, 'GenerateMeetingTranscriptLambdaRole',
    ...
    sageMakerModel = sagemaker.CfnModel(self, 'SageMakerModel',
    ...
    generateMeetingTranscript = aws_lambda.CfnFunction(self, 'GenerateMeetingTranscript',
    ...
    sageMakerEndpointConfig = sagemaker.CfnEndpointConfig(self, 'SageMakerEndpointConfig',
    ...
    generateMeetingTranscriptInvokePermission = aws_lambda.CfnPermission(self, 'GenerateMeetingTranscriptInvokePermission',
    ...
    sageMakerEndpoint = sagemaker.CfnEndpoint(self, 'SageMakerEndpoint',
    ...
    generateMeetingNotes = aws_lambda.CfnFunction(self, 'GenerateMeetingNotes',
    ...
    generateMeetingNotesInvokePermission = aws_lambda.CfnPermission(self, 'GenerateMeetingNotesInvokePermission',
    ...
    bucketPolicy = s3.CfnBucketPolicy(self, 'BucketPolicy',
          bucket = bucket.ref,
          policy_document = {
