...
def delete_user_template(table, user_id: str, template_id: str) -> bool:
    ...
    try:
        ...
        logger.error(f"Error deleting template {template_id} for user {user_id}: {str(e)}")
        raise e


def get_template_by_id(table, user_id: str, template_id: str) -> Optional[Dict[str, Any]]:
    """
    ...
    try:
        ...
        logger.error(f"Error retrieving template {template_id} for user {user_id}: {str(e)}")
        raise e
