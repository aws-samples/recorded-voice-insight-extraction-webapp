...
def lambda_handler(event, context):
    ...
    try:
        ...
        try:
            ...
            for template in default_templates:
                formatted_template = {
                    ...
                    "model_id": template.get("model_id", "anthropic.claude-3-sonnet-20240229-v1:0"),
                    "bedrock_kwargs": template.get("bedrock_kwargs", {
                        "temperature": 0.1,
                        "max_tokens": 2000
                    })
                }
        ...
        try:
            ...
            logger.info(f"Retrieved {len(user_templates)} user-specific templates for user: {username}")
